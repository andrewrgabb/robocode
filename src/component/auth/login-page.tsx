...
const LoginPage = () => {
    ...
    const [loginDetails, setLoginDetails] = useState<loginDetailsType>(initialLoginDetails);
    const [loginError, setLoginError] = useState<loginErrorType>(inititalLoginError);
